...
st.write("In Activity One, you will have the chance to prepare for a difficult conversation by interacting with a chatbot. You can choose to the level of difficulty to help you practice having conversations with people who might be a little difficult and avoidant or defensive, or increasing in difficult where the person is highly defensive and attacks back and finally at the hardest level, where the person is extremely disengaged to the point where the chatbot might just leave!")
